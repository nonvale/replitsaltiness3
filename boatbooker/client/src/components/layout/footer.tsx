    ...
    <footer className="bg-ocean-navy/80 text-ocean-navy py-12 relative z-50 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-ocean-navy">{t('footer.quick_links')}</h4>
            <ul className="space-y-2">
              <li><a href="/fleet" className="text-ocean-navy hover:text-ocean-blue transition-colors">{t('footer.fleet')}</a></li>
              <li><a href="#destinazioni" className="text-ocean-navy hover:text-ocean-blue transition-colors">{t('footer.destinations')}</a></li>
              <li><a href="#servizi" className="text-ocean-navy hover:text-ocean-blue transition-colors">{t('footer.services')}</a></li>
              <li><a href="#contatti" className="text-ocean-navy hover:text-ocean-blue transition-colors">{t('footer.contacts')}</a></li>
            </ul>
          </div>
          {/* Contact Info */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-ocean-navy">{t('footer.contacts')}</h4>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-ocean-navy">
          <p>&copy; 2024 Saltiness - Apulian Experience. {t('footer.rights')}</p>
